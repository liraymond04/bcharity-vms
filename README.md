...
The Typedoc page is generated using Github Actions and pushed to the `gh-pages` branch, which is then deployed to Github Pages.
...
To use inlang's machine translation, run `pnpm dlx @inlang/cli@latest machine translate`.
