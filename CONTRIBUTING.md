# Contributing to bcharity-vms

bcharity-vms is an open-source project, we appreciate your interest and efforts to contribute.
...
bcharity-vms is an open-source project. See the [LICENSE](https://github.com/liraymond04/bcharity-vms/LICENSE) file for licensing information. All the work done is available on GitHub.

The maintainers and the contributors send merge requests which go through the same validation process.

## Feature Requests

Feature Requests by the community are highly encouraged. Please feel free to create an [issue](https://github.com/liraymond04/bcharity-vms/issues/new) or to upvote 👍 [an existing issue](https://github.com/liraymond04/bcharity-vms/issues) in the GitHub.
...
We are using [GitHub Issues](https://github.com/liraymond04/bcharity-vms/issues) to manage our public bugs. We keep a close eye on this so before filing a new issue, try to make sure the problem does not already exist.
...
This contributing guide is based on [Lenster's](https://github.com/lensterxyz/lenster/main/CONTRIBUTING.md) guide.
