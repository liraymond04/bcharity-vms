        ...
        <section className="flex justify-left items-center border rounded-lg my-10 mx-20">
          <div className="flex m-8 flex-col space-y-5">
            ...
            <p className="mb-5">
              ...
              email at admin@bcharity.net. These Legal Terms constitute a
              legally binding agreement made between you, whether personally or
              on behalf of an entity ('you'), and BCharity, concerning your
              ...
              changes or modifications to these Legal Terms at any time and for
              ...
              revised Legal Terms by your continued use of the Services after
              the date such revised Legal Terms are posted. The Services are
            ...
            <p className="mb-5">
              ...
              only. Your use of our Services Subject to your compliance with
              ...
              licence to: access the Services; and download or print a copy of
              any portion of the Content to which you have properly gained
              access. solely for your personal, non-commercial use or internal
              business purpose. Except as set out in this section or elsewhere
              ...
              written permission. If you wish to make any use of the Services,
              Content, or Marks other than as set out in this section or
              elsewhere in our Legal Terms, please address your request to:
              admin@bcharity.net. If we ever grant you the permission to post,
              ...
              or displaying our Content. We reserve all rights not expressly
              granted to you in and to the Services, Content, and Marks. Any
              ...
              contributions Please review this section and the 'PROHIBITED
              ...
              also be treated as a Contribution. You understand that
              Contributions may be viewable by other users of the Services and
              possibly through third-party websites. When you post
              Contributions, you grant us a licence (including use of your name,
              ...
              exploit your Contributions (including, without limitation, your
              image, name, and voice) for any purpose, commercial, advertising,
              or otherwise, to prepare derivative works of, or incorporate into
              ...
              media formats and through any media channels. This licence
              ...
              networking accounts, you: confirm that you have read and agree
              with our 'PROHIBITED ACTIVITIES' and will not post, send, publish,
              ...
              account and report you to the authorities. Copyright infringement
            ...
            <p className="mb-5">
              ...
              of the Services, you agree not to: Systematically retrieve data or
              other content from the Services to create or compile, directly or
              ...
              account information such as user passwords. Circumvent, disable,
              ...
              or harm another person. Make improper use of our support services
              or submit false reports of abuse or misconduct. Use the Services
              ...
              system, such as using scripts to send comments or messages, or
              ...
              or services connected to the Services. Harass, annoy, intimidate,
              or threaten any of our employees or agents engaged in providing
              any portion of the Services to you. Attempt to bypass any measures
              ...
              Services, or use or launch any unauthorised script or other
              software. Use a buying agent or purchasing agent to make purchases
              on the Services. Make any unauthorised use of the Services,
              ...
              pretences. Use the Services as part of any effort to compete with
              us or otherwise use the Services and/or the Content for any
              revenue-generating endeavour or commercial enterprise. Sell or
              otherwise transfer your profile. Use the Services to advertise or
            ...
            <p className="mb-5">
              ...
              creator and owner of or have the necessary licences, rights,
              consents, releases, and permissions to use and to authorise us,
              ...
              unauthorised advertising, promotional materials, pyramid schemes,
              ...
              applicable law or regulation. Any use of the Services in violation
              of the foregoing violates these Legal Terms and may result in,
            ...
            <p className="mb-5">
              ...
              authorise sublicences of the foregoing. The use and distribution
              ...
              Contributions; (2) to re-categorise any Contributions to place
            ...
            <p className="mb-5">
              ...
              Please be advised the Services are hosted in Canada. If you access
              ...
              your data to Canada, and you expressly consent to have your data
              transferred to and processed in Canada. Further, we do not
            ...
            <p className="mb-5">
              ...
              discontinuance of the Services. Nothing in these Legal Terms will
              be construed to obligate us to maintain and support the Services
            ...
            <p className="mb-5">
              ...
              Terms to the jurisdiction of the Canada courts. BCharity shall
              also maintain the right to bring proceedings as to the substance
