  ...
  const tabs = [
    {
      ...
      makeRow: (op: OpportunityMetadata) => {
        ...
        return (
          <div
            className={`flex items-center border border-gray-500 dark:border-black ${
              active
          ...
          >
            <div
              className={`text-xs border border-gray-500 ml-3 w-14 shrink-0 ${
                active
                  ? 'bg-emerald-200 dark:bg-green-700'
                      ...
                      <div className="w-3/5 grow">
                        <div className="ml-4">
                          ...
                          <div className="flex space-x-3 my-2">
                            ...
                            {getSlug('twitter') !== '' && (
                              <Link
                                href={`https://twitter.com/${getSlug(
                                  'twitter'
                                )}`}
                                target="_blank"
                              >
                        ...
                        {tabs.map((v, i) => {
                          return (
                            <p
                              ...
                              className={`px-3 cursor-pointer border border-zinc-400 dark:border-black ${
                                i === selectedTabIndex
                                  ? 'bg-white dark:bg-black'
                                  : 'bg-brand-200 dark:bg-gray-700'
                              }`}
                            >
                              {v.title}
                            </p>
