          ...
          <div className="text-2xl font-normal text-black dark:text-white sm:text-2x l">
            ...
            <div className="flex items-center mt-12 mb-8">
              <input
                ...
                type="checkbox"
                value=""
                className="w-8 h-8 text-blue-600 bg-accent-content dark:bg-base-300 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:border-gray-600"
              />
              <label
