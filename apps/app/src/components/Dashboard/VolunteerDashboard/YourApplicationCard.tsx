 ...
 */
export interface YourApplicationCardProps {
  /**
 ...
 * the application.
 */
const YourApplicationCard: React.FC<YourApplicationCardProps> = ({
  application,
  onCancel,
  pending
}) => {
  ...
  useEffect(() => {
    ...
    let profileId = application.opportunity.name
    if (application.manual === 'true')
      profileId = application.opportunity.description
      ...
      {!userProfile ? (
        ...
        <>
          <div className="justify-start flex">
            ...
            <p suppressHydrationWarning>applied to</p>
          </div>
